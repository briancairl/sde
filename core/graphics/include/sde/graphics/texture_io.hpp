...
template <typename Archive> struct save<Archive, graphics::TextureHandle>
{
  void operator()(Archive& ar, const graphics::TextureHandle& handle) const;
};

template <typename Archive> struct load<Archive, graphics::TextureHandle>
{
  void operator()(Archive& ar, graphics::TextureHandle& handle) const;
};
