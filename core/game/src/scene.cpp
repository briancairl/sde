...
//     {
//       SDE_LOG_DEBUG_FMT("field[%s] 'version' mismatch %lu vs %lu", field.name, Version(field).value,
//       previous_version); return false;
//     }
...
//     {
//       SDE_LOG_DEBUG_FMT(
//         "script[%s] 'version' mismatch %lu vs %lu", script_type.c_str(), script_ptr->version().value,
//         previous_version);
//       return false;
//     }
