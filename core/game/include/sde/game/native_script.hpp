...
private:
  ...
  bool when_created(dependencies deps, NativeScriptHandle handle, NativeScriptData* data);
  bool when_removed(dependencies deps, NativeScriptHandle handle, const NativeScriptData* data);
};
