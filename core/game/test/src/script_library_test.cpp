...
bool initialize(custom_script* self, sde::game::Assets& assets, const sde::AppProperties& app_props) { return true; }

bool update(custom_script* self, sde::game::Assets& assets, const sde::AppProperties& app_props) { return true; }
