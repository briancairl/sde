  ...
  const AppProperties& app)
{
  const CharacterTextures character_textures{
    .front_atlas =
      [&] {
        auto atlas_or_error =
          assets.textures_from_disk.create("/home/brian/dev/assets/sprites/red/Top Down/Front Movement.png");
    ...
    .back_atlas =
      [&] {
        auto atlas_or_error =
          assets.textures_from_disk.create("/home/brian/dev/assets/sprites/red/Top Down/Back Movement.png");
        SDE_ASSERT_TRUE(atlas_or_error.has_value());
        return atlas_or_error->handle;
      }(),
    .side_atlas =
      [&] {
        auto atlas_or_error =
          assets.textures_from_disk.create("/home/brian/dev/assets/sprites/red/Top Down/Side Movement.png");
        SDE_ASSERT_TRUE(atlas_or_error.has_value());
        return atlas_or_error->handle;
      }(),
    .front_side_atlas =
      [&] {
        auto atlas_or_error =
          assets.textures_from_disk.create("/home/brian/dev/assets/sprites/red/Top Down/FrontSide Movement.png");
        SDE_ASSERT_TRUE(atlas_or_error.has_value());
        return atlas_or_error->handle;
      }(),
    .back_side_atlas =
      [&] {
        auto atlas_or_error =
          assets.textures_from_disk.create("/home/brian/dev/assets/sprites/red/Top Down/BackSide Movement.png");
        SDE_ASSERT_TRUE(atlas_or_error.has_value());
        return atlas_or_error->handle;
      }()};
